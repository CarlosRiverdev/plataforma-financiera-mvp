...
/** Campo numérico con unidad adosada y mensaje de error debajo. */
export default function CampoNumero({
  ...
  return (
    <div>
      <label className="mb-1.5 block text-[13px] font-medium text-[#5a6872]">{etiqueta}</label>
      ...
      <p className="mt-1 min-h-[17px] text-[12.5px] text-[#a3321e]">{error}</p>
    </div>
  );
}
